...
const CreateQuestion = () => {
  ...
  const handleSaveQuestion = () => {
    ...
    if (updatedQuestion.content === "") {
      ...
      updatedQuestion.answers.some((answer) => answer.isAnswer === true) ===
      false
    ) {
      notification.error({
        message: "Error save question",
  ...
  const handleDeleteQuestion = (id) => {
    const newSavedQuestions = savedQuestions.filter(
  ...
  const handleSaveQuizz = async () => {
    ...
    console.log(
      " Sending full formattedQuestions to API:\n",
        ...
        >
          ...
          >
            ...
            <Upload
              ...
              style={{ width: "100%" }}
            >
              <Button icon={<UploadOutlined />} className="text-input">
                Click to Upload
              </Button>
            </Upload>
            <Upload
